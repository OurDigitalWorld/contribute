...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.date_modified'
        db.add_column('DataEntry_record', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(blank=True, auto_now=True, default=datetime.datetime(2013, 12, 4, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.date_modified'
        db.delete_column('DataEntry_record', 'date_modified')
