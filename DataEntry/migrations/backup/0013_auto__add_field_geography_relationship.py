...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Geography.relationship'
        db.add_column('DataEntry_geography', 'relationship',
                      self.gf('django.db.models.fields.CharField')(blank=True, null=True, max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Geography.relationship'
        db.delete_column('DataEntry_geography', 'relationship')
