...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.slug'
        db.add_column('DataEntry_record', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=60, blank=True, default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.slug'
        db.delete_column('DataEntry_record', 'slug')
