...
class RecordResource(ModelResource):
    recordobject = fields.ToManyField(RecordObjectResource, 'recordobject_set', related_name='record', full=True, null=True, blank=True)
    geography = fields.ToManyField(GeographyResource, 'geography_set', related_name='record', full=True, null=True, blank=True)
