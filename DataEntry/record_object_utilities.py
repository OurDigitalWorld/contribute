...
def add_record_object(record_id, record_object_category_id, target_file, source_file, fulltext = ''):
    ...
    if record_object_category_id == 1 or record_object_category_id == 2 or record_object_category_id == 3 or record_object_category_id == 0:
